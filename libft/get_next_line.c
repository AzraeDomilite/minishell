...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/05 11:35:44 by blucken           #+#    #+#             */
/*   Updated: 2025/05/05 11:36:08 by blucken          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_str_list	*newline_in_list(t_str_list *rest)
{
	if (!rest)
		return (NULL);
...
char	*add_string_to_back_of_list(t_str_list **rest, char *str)
{
	t_str_list	*new;
	t_str_list	*old;
	char		*new_str;
...
char	*manage_rest_and_return_newline(t_str_list **rest, char *left_over)
{
	t_str_list	*split;
	char		*s;
...
char	*read_to_buffer(int fd, t_str_list **rest, \
		char *buffer, char *left_over)
{
	char	*result;
	ssize_t	bytes_read;
