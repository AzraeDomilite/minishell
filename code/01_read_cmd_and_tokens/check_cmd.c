...
/*   Updated: 2025/03/05 18:56:11 by blucken          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

/**
 * @file	check_cmd.c
 * @brief	define functions to check completeness (while user
...
// todo: add check for subshell that is followed only by modifier pairs without 
// additional args
/**
 ...
 * @return			separator string in case the command is incomplete, 
 * 					NULL otherwise
*/
